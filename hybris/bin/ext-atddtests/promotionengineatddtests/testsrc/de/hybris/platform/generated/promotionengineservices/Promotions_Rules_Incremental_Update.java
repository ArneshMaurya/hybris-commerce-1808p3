...
@IntegrationTest
public class Promotions_Rules_Incremental_Update extends ServicelayerTest implements RobotTestContext
{
	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotSettings.setLogName("Promotions_Rules_Incremental_Update-log");
			robotSettings.setOutputName("Promotions_Rules_Incremental_Update-output");
			robotSettings.setReportName("Promotions_Rules_Incremental_Update-report");
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"D:/hybris-commerce-1808p3/hybris/bin/ext-atddtests/promotionengineatddtests/genresources/robottests/Promotions_Rules_Incremental_Update.txt"));
		}
