...
public class Cart_Promotion_Rules extends ServicelayerTest implements RobotTestContext
{
	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"D:/hybris-commerce-1808p3/hybris/bin/ext-atddtests/promotionengineatddtests/genresources/robottests/Cart_Promotion_Rules.txt"));
		}
	...
	public void Test_Apply_Not_Exclusive_Promotions_To_Cart_()
	{
		...
		final String robotTestName = "Test_Apply_Not_Exclusive_Promotions_To_Cart_";
	...
	public void Test_Apply_Exclusive_Promotions_To_Cart_()
	{
		...
		final String robotTestName = "Test_Apply_Exclusive_Promotions_To_Cart_";
