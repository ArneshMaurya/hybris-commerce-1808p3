...
public class Promotions_Rules extends ServicelayerTest implements RobotTestContext
{
	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"D:/hybris-commerce-1808p3/hybris/bin/ext-atddtests/promotionengineatddtests/genresources/robottests/Promotions_Rules.txt"));
		}
	...
	@Test
	public void Test_Apply_Percentage_Discount_Excluding_GroupType_For_Product_Promotion()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Apply_Percentage_Discount_Excluding_GroupType_For_Product_Promotion";
	...
	@Test
	public void Test_Order_Threshold_Free_Gift_Promos_Not_Exclusive_Rule_Groups()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Order_Threshold_Free_Gift_Promos_Not_Exclusive_Rule_Groups";
	...
	@Test
	public void Test_Order_Threshold_Free_Gift_Promos_Exclusive_Rule_Groups()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Order_Threshold_Free_Gift_Promos_Exclusive_Rule_Groups";
	...
	@Test
	public void Test_No_Halt()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_No_Halt";
	...
	public void Test_Halt()
	{
		...
		final String robotTestName = "Test_Halt";
	...
	@Test
	public void Test_Halt_First()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Halt_First";
