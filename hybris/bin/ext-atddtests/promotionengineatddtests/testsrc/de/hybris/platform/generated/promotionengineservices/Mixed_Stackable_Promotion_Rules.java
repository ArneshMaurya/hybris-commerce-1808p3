...
@IntegrationTest
public class Mixed_Stackable_Promotion_Rules extends ServicelayerTest implements RobotTestContext
{
	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotSettings.setLogName("Mixed_Stackable_Promotion_Rules-log");
			robotSettings.setOutputName("Mixed_Stackable_Promotion_Rules-output");
			robotSettings.setReportName("Mixed_Stackable_Promotion_Rules-report");
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"D:/hybris-commerce-1808p3/hybris/bin/ext-atddtests/promotionengineatddtests/genresources/robottests/Mixed_Stackable_Promotion_Rules.txt"));
		}
	...
	@Test
	public void Test_Apply_Stackable_Promotions_Product_Order_TC_QA_7579()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Apply_Stackable_Promotions_Product_Order_TC_QA_7579";
	...
	@Test
	public void Test_Apply_Stackable_Promotions_Product_Product_TC_QA_7581()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Apply_Stackable_Promotions_Product_Product_TC_QA_7581";
