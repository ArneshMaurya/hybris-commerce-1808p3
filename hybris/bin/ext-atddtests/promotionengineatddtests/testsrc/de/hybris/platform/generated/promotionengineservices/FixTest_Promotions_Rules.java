...
@IntegrationTest
public class FixTest_Promotions_Rules extends ServicelayerTest implements RobotTestContext
{
	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotSettings.setLogName("FixTest_Promotions_Rules-log");
			robotSettings.setOutputName("FixTest_Promotions_Rules-output");
			robotSettings.setReportName("FixTest_Promotions_Rules-report");
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"D:/hybris-commerce-1808p3/hybris/bin/ext-atddtests/promotionengineatddtests/genresources/robottests/FixTest_Promotions_Rules.txt"));
		}
	...
	@Test
	public void Test_Fix_For_Stackable_Entry_Percentage_Promotions()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Fix_For_Stackable_Entry_Percentage_Promotions";
