	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/opt/bambooagent/xml-data/temporary-repositories/maintenance/hybris/bin/ext-atddtests/subscriptionatddtests/genresources/robottests/Subscription_Term_Tests.txt"));
		}
