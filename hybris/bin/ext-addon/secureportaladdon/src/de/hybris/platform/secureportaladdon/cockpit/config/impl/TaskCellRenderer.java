 ...
 */
public class TaskCellRenderer extends de.hybris.platform.cockpit.services.config.impl.TaskCellRenderer // NOSONAR
{
	...
	protected void showNotification(final TableModel model, final Component parent, final String message)
	{
		...
		UISessionUtils.getCurrentSession().sendGlobalEvent(new ItemChangedEvent(parent, null, Collections.emptyList()));
	}

	/**
	 * @return WorkflowAttachmentService instance from the {@link Registry}
	 */
	protected WorkflowAttachmentService getWorkflowAttachmentService()	//NOSONAR
	{
