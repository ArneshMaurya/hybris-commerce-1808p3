 ...
 */
package de.hybris.platform.marketplaceoccaddon.setup;
 ...
 *
 */
@SystemSetup(extension = MarketplaceoccaddonConstants.EXTENSIONNAME)
public class MarketplaceOccAddonDataSetup extends AbstractSystemSetup
{
